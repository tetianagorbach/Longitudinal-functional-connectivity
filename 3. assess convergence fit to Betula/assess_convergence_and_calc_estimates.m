...
% iterations of MCMC and the estimates of the parameters using trace with seed 0.
% Note: theta is the last element of alphas and deltas.
% Input:
%   seq_post : MCMC iterations to use in the calculation of the scale 
%   reduction factor    
% Output: 
%   r: scale reduction factor for all the parameters in the model 
%   (min and max value and histogram)
% 
%% read the traces
...
%% transform the data into par_of_interest where each cell contains 
% the matrix of size [3, length(seq_post)] with seq_post MCMC iterations of 
% considered 3 traces for one parameter
