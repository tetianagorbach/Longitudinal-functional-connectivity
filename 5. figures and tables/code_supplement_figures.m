% This file saves Supplementary figures 1-4 in separate pdf
% files within the specified current directory. The current dirrectory must
% contain files with the MCMC traces.

%% read traces
% add the folder with "3. assess convergence fit to Betula" and 3 traces to search path
start_names_traces = '../3. assess convergence fit to Betula/trace_2t_with_missing_seed';
...
seq_post =  1000:5:6000; % iterations used for posterior estimation
seq_autocorr =  1000:6000; % iterations used for autocorrelation computation

%% Supplementary Figure 1: convergence of alphas
